...
- Реализуйте класс `com.javawebinar.basejava.storage.ArrayStorage`, организовав хранение резюме на основе массива с методами `save, get, delete, size, clear, getAll`
...
```
- Протестируйте вашу реализацию с помощью классов `com.javawebinar.basejava.MainArray.main()` и `com.javawebinar.basejava.MainTestArrayStorage.main()`
...
6. `com.javawebinar.basejava.model.Resume r` — давай переменным осмысленные имена, например `resume`. `r` допустимо в коротких циклах и лямбдах.
